...
class Scraper
  ...
  data = Nokogiri::HTML(open("https://www.nycgovparks.org/park-features/parks-list"))
  https://www.nycgovparks.org/park-features/parks-list
  data.css("div.nav nav-tabs a").collect do |parks|
